...
<<<<<<< HEAD
				  $(PARS)parsing.c $(PARS)dollar.c $(PARS)parsing_cat.c $(PARS)utils_quotes.c $(PARS)remove_quotes.c $(PARS)utils_parsing.c $(PARS)syntax_errors.c $(PARS)utils_syntax_errors.c $(PARS)get_full_pipe.c $(PARS)preparsing.c $(PARS)parsing_redirection.c\
=======
				  $(PARS)parsing.c $(PARS)dollar.c $(PARS)parsing_cat.c $(PARS)utils_quotes.c $(PARS)remove_quotes.c $(PARS)utils_parsing.c $(PARS)syntax_errors.c $(PARS)syntax_errors_2.c $(PARS)get_full_pipe.c $(PARS)preparsing.c\
