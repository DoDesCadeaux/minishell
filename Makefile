...
CFLAGS	= -Wall -Wextra -Werror -lreadline -L/Users/$(USER)/.brew/opt/readline/lib -I/Users/$(USER)/.brew0/opt/readline/include -g3 -fsanitize=address
...
SRCS			= $(TOK)tokenisation.c	$(TOK)tok_cmd.c $(TOK)tok_stdin.c $(TOK)tok_stdout.c $(TOK)utils_tokenisation.c $(TOK)check_type.c $(TOK)utils_tok_cmd.c $(TOK)utils_less_redir.c $(TOK)utils_great_redir.c $(TOK)check_status_binary.c \
				  ...
				  $(EXEC)exec_global.c $(EXEC)pipe.c $(EXEC)get_path.c $(EXEC)split_pipe.c $(EXEC)utils_pipe.c $(EXEC)utils_run_exec.c $(EXEC)exec_utils.c $(EXEC)pipe_loop.c \
