...
SRCS			= $(TOK)tokenisation.c	$(TOK)tok_cmd.c $(TOK)tok_stdin.c $(TOK)tok_stdout.c $(TOK)utils_tokenisation.c $(TOK)check_type.c $(TOK)utils_tok_cmd.c $(TOK)utils_redirections.c $(TOK)check_status_binary.c \
				  ...
				  $(PARS)parsing.c $(PARS)dollar.c $(PARS)parsing_cat.c $(PARS)utils_quotes.c $(PARS)remove_quotes.c $(PARS)utils_parsing.c $(PARS)syntax_errors.c $(PARS)syntax_errors_2.c $(PARS)get_full_pipe.c $(PARS)preparsing.c $(PARS)parsing_redirection.c\
